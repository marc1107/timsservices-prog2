...
public class Tokenizer
{
	...
	public Tokenizer(String s)
	{
		...
		// System.out.println("Used decimal separator: " + ((DecimalFormat)
		// f).getDecimalFormatSymbols().getDecimalSeparator());
		// }
	}
	 ...
	 *
	 * @return String aus KEYWORDS oder double-Wert, falls das nächste Token eine
	 *         Gleitkommazahl ist; null bei Fehler. Bei String-Ende wird "$"
	 *         zurückgeliefert.
	 */
	 ...
	 */
	/*
	 * public static void main(String[] args) { String s = "2^3+3.2*4.5+4";
	 * Tokenizer tokenizer = new Tokenizer(s); Object token; while ((token =
	 * tokenizer.nextToken()) != null) { System.out.println(token); } }
	 */
}
